        ...
        if author_list is not None:
            ...
            for author in authors_list:
                ...
                if author.find("Identifier") is not None:
                    ...
                    identifier = ""
                affiliation_list = []
                if author.findall("AffiliationInfo/Affiliation") is not None:

                    affiliation_list_temp = author.findall("AffiliationInfo/Affiliation")
                    for affiliation in affiliation_list_temp:
                        if affiliation.text is not None:
                            affiliation_list.append(affiliation.text)
