...
app = FastAPI()
client = motor.motor_asyncio.AsyncIOMotorClient("mongodb+srv://varshita:Madhavi$12345@reviewerclustervarshita.aeufpbd.mongodb.net/reviewer-database?retryWrites=true&w=majority")
print("Mongodb url: ", client)
